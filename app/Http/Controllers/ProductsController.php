...
class ProductsController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        return redirect('student')->with('msg', 'Criado com sucesso');
    ...
    public function update(Request $request, $id)
    {
        ...
        return redirect('student')->with('msg', 'Alterações salvas!');
    }
    ...
    {
        Products::destroy($id);
        return redirect('student')->with('msg', 'Produto excluído!');
    }
}